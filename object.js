...
const q1 = new Question('Which country embassy in Nairobi was bombed on 7 August 1998?',['UK','USA','France','Chile'],'USA');
const q2 = new Question('Which is the currency of Kenya?',['Crown','Guinea','Penny','Shilling'], 'Shilling');
const q3 = new Question(' Which of the following countries does not have a border with Kenya?',['Ethiopia','Sudan','Uganda','Eritrea'],'Eritrea');
const quiz = new Quiz([q1, q2, q3]);
quiz.getNextQuestion();
quiz.answerCurrentQuestion('USA');
quiz.getNextQuestion();
quiz.answerCurrentQuestion('Shilling');
quiz.getNextQuestion();
quiz.answerCurrentQuestion('Eritrea');
